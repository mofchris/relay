...
const footerLinks: FooterSection[] = [
  {
    ...
    links: [
      ...
      { title: "Open console", href: "/app", to: "/app" },
    ],
  },
  {
    label: "Platform",
      ...
      <div className="grid w-full gap-8 py-6 md:py-8 lg:grid-cols-3 lg:gap-8">
        <AnimatedContainer className="space-y-4">
          ...
          <p className="mt-8 max-w-xs text-muted-foreground text-sm md:mt-0">
            Real-time ad delivery and analytics, built for scale.
          </p>
          <p className="text-muted-foreground text-xs">Portfolio demo — synthetic data, no real ad serving.</p>
        </AnimatedContainer>
